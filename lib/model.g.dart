        ...
        case 'hintsUsed':
          result.hintsUsed =
              serializers.deserialize(
                  ...
                  as int;
          break;
        case 'revealedLocations':
          result.revealedLocations.replace(
            serializers.deserialize(
                  value,
                  specifiedType: const FullType(BuiltSet, const [
                    const FullType(Location),
...
class _$CrosswordPuzzleGame extends CrosswordPuzzleGame {
  ...
  final int hintsUsed;
  @override
  final BuiltSet<Location> revealedLocations;
  ...
  _$CrosswordPuzzleGame._({
    ...
    required this.revealedLocations,
  }) : super._();
  @override
  ...
  bool operator ==(Object other) {
    ...
    return other is CrosswordPuzzleGame &&
        ...
        revealedLocations == other.revealedLocations;
  }
  ...
  int get hashCode {
    ...
    _$hash = $jc(_$hash, hintsUsed.hashCode);
    _$hash = $jc(_$hash, revealedLocations.hashCode);
    _$hash = $jf(_$hash);
    return _$hash;
  }
  ...
  String toString() {
    return (newBuiltValueToStringHelper(r'CrosswordPuzzleGame')
          ...
          ..add('hintsUsed', hintsUsed)
          ..add('revealedLocations', revealedLocations))
        .toString();
  }
}
...
class CrosswordPuzzleGameBuilder
  ...
  int? _hintsUsed;
  int? get hintsUsed => _$this._hintsUsed;
  set hintsUsed(int? hintsUsed) => _$this._hintsUsed = hintsUsed;

  SetBuilder<Location>? _revealedLocations;
  SetBuilder<Location> get revealedLocations =>
      _$this._revealedLocations ??= SetBuilder<Location>();
  set revealedLocations(SetBuilder<Location>? revealedLocations) =>
      _$this._revealedLocations = revealedLocations;
  ...
  CrosswordPuzzleGameBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _hintsUsed = $v.hintsUsed;
      _revealedLocations = $v.revealedLocations.toBuilder();
      _$v = null;
    }
    return this;
  }
    ...
    try {
      _$result =
          ...
          _$CrosswordPuzzleGame._(
            ...
            hintsUsed: BuiltValueNullFieldError.checkNotNull(
              hintsUsed,
              r'CrosswordPuzzleGame',
              'hintsUsed',
            ),
            revealedLocations: revealedLocations.build(),
          );
    } catch (_) {
      late String _$failedField;
      try {
        ...
        _$failedField = 'revealedLocations';
        revealedLocations.build();
      } catch (e) {
        throw BuiltValueNestedFieldError(
          r'CrosswordPuzzleGame',
          _$failedField,
